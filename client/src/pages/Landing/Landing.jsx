...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 transition-colors dark:bg-[#090d16] dark:text-slate-100 selection:bg-indigo-500 selection:text-white relative overflow-hidden">
      ...
      {/* 1. TOP NAVBAR                                                 */}
      {/* ------------------------------------------------------------- */}
      <header className="sticky top-0 z-50 border-b border-gray-200/80 bg-white/80 backdrop-blur-md transition-colors dark:border-slate-800/80 dark:bg-slate-950/80">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          {/* Brand */}
          <Link to="/" className="flex items-center gap-2.5 transition hover:opacity-90">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-purple-600 text-white shadow-md shadow-indigo-500/25">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="inline-flex items-center rounded-md bg-indigo-50 px-1.5 py-0.5 text-xs font-bold text-indigo-700 ring-1 ring-inset ring-indigo-700/10 dark:bg-indigo-950/70 dark:text-indigo-300 dark:ring-indigo-500/20">
          ...
          <div className="flex items-center gap-3">
            ...
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2 text-xs font-bold text-white shadow-md shadow-indigo-500/25 transition hover:from-indigo-500 hover:to-purple-500 active:scale-95"
              >
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl bg-indigo-600 px-4 py-2 text-xs font-bold text-white shadow-md shadow-indigo-600/25 transition hover:bg-indigo-500 active:scale-95"
                >
